                ...
                <form method="POST" action="{{ route('inventory.update') }}" enctype="multipart/form-data"  autocomplete="off">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-2 bg-white sm:p-6">
                            ...
                            <input type="text" name="item_name" id="item_name" value="{{ $item['item_name'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-2 bg-white sm:p-6">
                            ...
                            <input type="text" name="description" id="description" value="{{ $item['description'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-2 bg-white sm:p-6">
                            ...
                            <input type="text" name="quantity" id="quantity" value="{{ $item['quantity'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
